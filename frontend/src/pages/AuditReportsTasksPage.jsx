...
import AuditReportsTasksTable from '../components/AuditReportsTasksTable'

const AuditReportsTasksPage = () => {
  return (
    <>
        <SidebarProvider>
            <DashboardLayout />
...
export default AuditReportsTasksPage