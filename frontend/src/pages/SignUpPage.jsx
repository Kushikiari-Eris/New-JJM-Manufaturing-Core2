  ...
  return (
    <>
        <div className='flex flex-col justify-center py-28 sm:px-6 lg:px-8'>
          <motion.div className='sm:mx-auto sm:w-auto sm:max-w-md' initial={{opacity: 0, y: -20}} animate={{opacity: 1, y: 0}} transition={{duration: 0.8}}>
          ...
          <motion.div className='mt-8 sm:mx-auto sm:w-full sm:max-w-md' initial={{opacity: 0, y: 20}} animate={{opacity: 1, y: 0}} transition={{duration: 0.8, delay: 0.2}}>
            <div className='bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10'>
              <form onSubmit={handleSubmit} className='space-y-6'>
                <div>
                  ...
                  <div className='mt-1 relative rounded-md shadow-sm'>
                    ...
                    className='block w-full px-3 py-2 pl-10 bg-gray-700 border border-gray-600 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-emerald-500
                    focus:border-emerald-500 sm:text-sm text-white' placeholder='john doe'
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className='mt-1 relative rounded-md shadow-md'>
                    ...
                    className='block w-full px-3 py-2 pl-10 bg-gray-700 border border-gray-600 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-emerald-500
                    focus:border-emerald-500 sm:text-sm text-white' placeholder='you@gmail.com'
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className='mt-1 relative rounded-md shadow-md'>
                    ...
                    className='block w-full px-3 py-2 pl-10 bg-gray-700 border border-gray-600 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-emerald-500
                    focus:border-emerald-500 sm:text-sm text-white' placeholder='*******'
                    />
                  </div>
                </div>
              ...
              <p className='mt-8 tex-center text-sm text-gray-400'>
