...
import AuditInProgressTasks from '../components/AuditInProgressTasks'

const AuditInProgressTaskPage = () => {
  return (
    <>
    <SidebarProvider>
      <DashboardLayout />
...
export default AuditInProgressTaskPage