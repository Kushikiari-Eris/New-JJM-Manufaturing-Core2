...
import useAuditRequestHr2Store from "../stores/useAuditRequestHr2Store";
import useAuditTaskStore from "../stores/auditTaskStore";

const AuditRequestHr2Table = () => {
    const { requests, loading, fetchRequests, deleteRequest } = useAuditRequestHr2Store();
    ...
    return (
        <div className="relative overflow-x-auto bg-white">
            <div className="flex items-center justify-between flex-column flex-wrap md:flex-row p-4">
                <h2 className="font-semibold text-xl">Human Resource 2 Requests</h2>
...
export default AuditRequestHr2Table;
