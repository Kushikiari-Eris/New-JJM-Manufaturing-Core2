...
import AuditRequestCore1Table from './AuditRequestCore1Table';
import AuditRequestCore2Table from './AuditRequestCore2Table';

const AuditRequestCoreTab = () => {
    const [activeTab, setActiveTab] = useState("tab1");
            
    const tabs = [
        { id: "tab1", title: "Core 1 Requests" },
        { id: "tab2", title: "Core 2 Requests" },
    ];
  return (
    <>
...
export default AuditRequestCoreTab