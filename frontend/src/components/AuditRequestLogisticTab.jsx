...
import AuditRequestLogistic1Table from './AuditRequestLogistic1Table';
import AuditRequestLogistic2Table from './AuditRequestLogistic2Table';

const AuditRequestLogisticTab = () => {
    const [activeTab, setActiveTab] = useState("tab1");
        
    const tabs = [
        { id: "tab1", title: "Logistic 1 Requests" },
        { id: "tab2", title: "Logistic 2 Requests" },
    ];
  return (
    <>
...
export default AuditRequestLogisticTab