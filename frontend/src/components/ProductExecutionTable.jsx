  ...
  return (
    <>
      ...
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg mt-10 bg-white">
        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            {currentExecutions.map((execution) => (
              <tr key={execution._id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                <td className="px-6 py-4 font-semibold text-gray-900">{execution._id}</td>
                ...
                <td className="px-6 py-4">{execution.productId || "N/A"}</td>
        ...
        {/* Pagination Controls */}
        <div className="flex justify-center space-x-2 py-4 bg-white dark:bg-gray-900">
          <button 
