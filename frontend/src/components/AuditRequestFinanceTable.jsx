...
import useAuditRequestFinanceStore from "../stores/useAuditRequestFinanceStore";
import useAuditTaskStore from "../stores/auditTaskStore";

const AuditRequestFinanceTable = () => {
    const { requests, loading, fetchRequests, deleteRequest } = useAuditRequestFinanceStore();
    ...
    return (
        ...
        <div className="relative overflow-x-auto bg-white mt-10 rounded-lg"> 
            <div className="flex items-center justify-between flex-column flex-wrap md:flex-row p-4">
                <h2 className="font-semibold text-xl">Finance Requests</h2>
...
export default AuditRequestFinanceTable;
