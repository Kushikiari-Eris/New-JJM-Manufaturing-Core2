...
import useAuditRequestHr4Store from "../stores/useAuditRequestHr4Store";
import useAuditTaskStore from "../stores/auditTaskStore";

const AuditRequestHr4Table = () => {
    const { requests, loading, fetchRequests, deleteRequest } = useAuditRequestHr4Store();
    ...
    return (
        <div className="relative overflow-x-auto bg-white">
            <div className="flex items-center justify-between flex-column flex-wrap md:flex-row p-4">
                <h2 className="font-semibold text-xl">Human Resource 4 Requests</h2>
...
export default AuditRequestHr4Table;
