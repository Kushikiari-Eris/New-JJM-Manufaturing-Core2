...
import useAuditRequestLogistic2Store from "../stores/useAuditRequestLogistic2Store";
import useAuditTaskStore from "../stores/auditTaskStore";

const AuditRequestLogistic2Table = () => {
    const { requests, loading, fetchRequests, deleteRequest } = useAuditRequestLogistic2Store();
    ...
    return (
        <div className="relative overflow-x-auto bg-white">
            <div className="flex items-center justify-between flex-column flex-wrap md:flex-row p-4">
                <h2 className="font-semibold text-xl">Logistic 2 Requests</h2>
...
export default AuditRequestLogistic2Table;
