...
import useAuditRequestHr1Store from "../stores/useAuditRequestHr1Store";
import useAuditTaskStore from "../stores/auditTaskStore";

const AuditRequestHr1Table = () => {
    const { requests, loading, fetchRequests, deleteRequest } = useAuditRequestHr1Store();
    ...
    return (
        <div className="relative overflow-x-auto bg-white">
            <div className="flex items-center justify-between flex-column flex-wrap md:flex-row p-4">
                <h2 className="font-semibold text-xl">Human Resource 1 Requests</h2>
...
export default AuditRequestHr1Table;
