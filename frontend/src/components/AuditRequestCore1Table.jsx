...
import useAuditRequestCore1Store from "../stores/useAuditRequestCore1Store";
import useAuditTaskStore from "../stores/auditTaskStore";

const AuditRequestCore1Table = () => {
    const { requests, loading, fetchRequests, deleteRequest } = useAuditRequestCore1Store();
    ...
    return (
        <div className="relative overflow-x-auto bg-white">
            <div className="flex items-center justify-between flex-column flex-wrap md:flex-row p-4">
                <h2 className="font-semibold text-xl">Core 1 Requests</h2>
...
export default AuditRequestCore1Table;
