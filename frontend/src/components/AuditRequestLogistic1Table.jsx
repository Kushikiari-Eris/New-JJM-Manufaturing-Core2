...
import useAuditRequestLogistic1Store from "../stores/useAuditRequestLogistic1Store";
import useAuditTaskStore from "../stores/auditTaskStore";

const AuditRequestLogistic1Table = () => {
    const { requests, loading, fetchRequests, deleteRequest } = useAuditRequestLogistic1Store();
    ...
    return (
        <div className="relative overflow-x-auto bg-white">
            <div className="flex items-center justify-between flex-column flex-wrap md:flex-row p-4">
                <h2 className="font-semibold text-xl">Logistic 1 Requests</h2>
...
export default AuditRequestLogistic1Table;
