                  ...
                  <div className="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
                    <div className="flex flex-col justify-start items-start dark:bg-gray-800 bg-gray-50 px-4 py-4 md:py-6 md:p-6 xl:p-8 w-full">
                      ...
                      {order.products.map((item) => (
                        <div
                          key={item._id}
                          className="mt-4 md:mt-6 flex flex-col border-b md:flex-row justify-start items-start md:items-center md:space-x-6 xl:space-x-8 w-full"
                        >
                          ...
                          <div className="md:flex-row flex-col flex justify-between items-start w-full pb-8 space-y-4 md:space-y-0">
                            <div className="w-full flex flex-col justify-start items-start space-y-8">
                              <h3 className="text-xl dark:text-white xl:text-1xl font-semibold leading-6 text-gray-800">{item.product.name}</h3>
                            </div>
                      ...
                      <div className="flex flex-col px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50 dark:bg-gray-800 space-y-6">
                        ...
                        <div className="flex justify-center items-center w-full space-y-4 flex-col border-gray-200 border-b pb-4">
                          <div className="flex justify-between w-full">
                            ...
                            <p className="text-base dark:text-gray-300 leading-4 text-gray-600">${order.totalAmount}</p>
                          </div>
                          <div className="flex justify-between items-center w-full">
                            ...
                            <p className="text-base dark:text-gray-300 leading-4 text-gray-600">-${order.discount}</p>
                          </div>
                          <div className="flex justify-between items-center w-full">
                            <p className="text-base dark:text-white leading-4 text-gray-800">Shipping</p>
                            <p className="text-base dark:text-gray-300 leading-4 text-gray-600">${order.shippingFee}</p>
                          </div>
                        </div>
                        :
                        <div className="flex justify-center items-center w-full space-y-4 flex-col border-gray-200 border-b pb-4">
                        ...
                        <div className="flex justify-between items-center w-full">
                          ...
                          <p className="text-base dark:text-gray-300 leading-4 text-gray-600">${order.totalAmount - order.discount + order.shippingFee}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex flex-col md:flex-row xl:flex-col justify-start items-stretch h-full w-full md:space-x-6 lg:space-x-8 xl:space-x-0">
                      ...
                      <div className="flex justify-between xl:h-full items-stretch w-full flex-col mt-6 md:mt-0">
                        ...
                        <div className="flex w-full justify-center items-center md:justify-start md:items-start">
                          <button onClick={handleConfirm} className="mt-6 md:mt-0 dark:border-white dark:hover:bg-gray-900 dark:bg-transparent dark:text-white py-5 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 border border-gray-800 font-medium w-96 2xl:w-full text-base leading-4 text-gray-800">
                            Confirm Order
                          </button>
                        </div>
                      </div>
