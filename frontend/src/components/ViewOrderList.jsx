    ...
    >
      ...
      >
        <div className="relative w-full max-w-6xl p-6">
          {/* Modal Container */}
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 min-h-[75vh]">
            {/* Header */}
                ...
                <div className="mt-4 space-y-3 text-gray-700 dark:text-gray-300">
                  ...
                  {order.discount && (
                    <div className="flex justify-between text-red-500">
                      <span>
                        Discount{" "}
                        <span className="bg-gray-200 dark:bg-gray-700 px-2 py-1 text-xs font-medium rounded">
                          COUPON
                        </span>
                      </span>
